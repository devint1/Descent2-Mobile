...
// Vector for blowing things up to full screen
#define FULLSCREEN_SCALE_PTS { {0, 0}, { i2f(640), i2f(480) }, { i2f(grd_curscreen->sc_w), i2f(grd_curscreen->sc_h) } }
...
extern fix Scale_factor;
extern fix Scale_x, Scale_y;
