...
void Java_tuchsen_descent2_DescentView_descentMain(JNIEnv *env, jobject thiz, jint w, jint h,
...
void Java_tuchsen_descent2_DescentActivity_descentPause(JNIEnv *env) {
	Want_pause = true;
}
