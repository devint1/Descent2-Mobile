...
Java_tuchsen_descent2_DescentView_descentMain(JNIEnv *env, jclass thiz, jint w, jint h,
...
JNIEXPORT void JNICALL
Java_tuchsen_descent2_DescentActivity_descentPause(JNIEnv *env, jclass clazz) {
	Want_pause = true;
}
