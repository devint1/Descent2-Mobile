...
void do_countdown_frame()
{
	...
	ConsoleObject->mtype.phys_info.rotvel.x += (fixmul(drand() - 16384, 3*F1_0/16 + (F1_0*(16-fc))/32))/div_scale;
	ConsoleObject->mtype.phys_info.rotvel.z += (fixmul(drand() - 16384, 3*F1_0/16 + (F1_0*(16-fc))/32))/div_scale;
